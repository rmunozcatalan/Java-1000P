...
public class Medicamento extends Narcotico{
    ...
    public Medicamento(String descProductos, int valProducto, int cantidad, String distribucion,String laboratorio) {
 ...
 public void aplicarDescuento(){
     int total= this.valorProducto*InterfaceVenta.iva-100;
