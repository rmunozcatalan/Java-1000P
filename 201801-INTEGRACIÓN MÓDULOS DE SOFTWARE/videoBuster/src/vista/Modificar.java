...
public class Modificar extends javax.swing.JFrame {
    ...
    public Modificar() {
        ...
        txtCodigo.setText(Listar.codigo + "");
        txtCodigo.setEnabled(false);
        txtPrecio.setText(Listar.precio + "");
        if (Listar.formato4k.equals("Disponible en 4K")) {
            chkFormato4k.setSelected(true);
        } else {
            chkFormato4k.setSelected(false);
        }
        txtNombre.setText(Listar.nombre);

        Categoria cat = new Categoria(Listar.id, Listar.categoria);
    ...
    private void initComponents() {
        ...
        btnAgregarPelicula.setText("Modificar Película");
    ...
    private void btnAgregarPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPeliculaActionPerformed
        ...
        if (rp.actualizarPelicula(pelicula)) {
            JOptionPane.showMessageDialog(this, "Se modificó la película con éxito", "Información", JOptionPane.INFORMATION_MESSAGE);

        } else {
            JOptionPane.showMessageDialog(this, "Ups!\nError al modificar la película", "Error", JOptionPane.ERROR_MESSAGE);
        }
        
        Listar.btnBuscar.doClick();
